...
**End of Term**: USHE End of Term FTE is a calculation is based off of the total number of student credit hours, based on the level of the course at the end of an academic term. End of Term FTE is based on snapshot data, this FTE returns a status FTE and may be modified to meet USHE reporting element criteria.
