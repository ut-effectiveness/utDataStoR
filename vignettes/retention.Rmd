...
Cohort retention metrics track the following cohorts as they progress toward graduation. UT has eight cohort retention metrics. #todo understand this statement# Cohort retention starts with a cohort of students (a group of students) and tracks if the student was enrolled (retained) as of census for the return term indicated; exclusions are removed from this metric. The denominator for this metric is the number of students within the cohort who do not have an exclusion flag. The numerator for the metric is the number of students from the denominator who do not have an exclusion flag and were enrolled as of census for the return term indicated.
