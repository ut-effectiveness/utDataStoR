...
The section counts sql is used to calculate the Census Section Count metric and the End of Term Section Count metric. This allows for detailed analysis of enrollment at the section level by various partitions (dimensions) such as college, department, course level, instructional method, etc.

```sql
`r display_sql_with_comments('course', 'section_counts.sql')`
```
