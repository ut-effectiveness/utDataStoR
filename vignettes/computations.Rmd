...
#### Year 
     Each headcount metric has the 5 most recent years of data if it is available (Summer census does not have 5 years of data). Depending on the time of year, it may mean that there are 4 complete years of academic year data, not 5 years.
