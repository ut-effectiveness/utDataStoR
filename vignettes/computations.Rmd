...
- Enrollment Funnel Census Headcount tracks the number of students at various stages within the fall enrollment funnel, categorized by student type and funnel status. It provides a snapshot at Census of how many students are at each stage of expressing interest in the university during the fall enrollment period.
...
Admissions Enrollment Funnel Rates are essential components of a university's enrollment process, providing insights into the effectiveness of various stages from initial interest to actual enrollment. They help the university understand and optimize their recruitment and admissions strategies.
...
- **Applicant to Admit Conversion Rate** Indicates the selectivity of the admissions process by showing the percentage of completed applications and our now fully admitted.

- **Admit to Committed Conversion Rate** Reflects the university's ability to persuade admitted students to commit to enrolling. These are students who have signed a enrollment intent form.

- **Admit to Enrolled Conversion Rate** Shows the success in converting admitted students into actual enrolled students, highlighting the effectiveness of follow-up and enrollment processes.
