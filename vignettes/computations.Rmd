...
- **Returned 1st Spring** - Student was enrolled at Fall Census in the First-time Freshman or Transfer Cohort and returned the following Spring term (second semester). For example enrolled in Fall 2020, returned Spring 2021.
