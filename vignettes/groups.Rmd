...
WITH cte AS
       ...
       proto AS ( --add an explaination for what this code does
           SELECT a.student_id,
                  CASE
...
## SQL for Online Program Student
-- want to add this to the student_term_level table (work with Candi)
```sql
