...
IPEDS Race/Ethnicity reports the student's race and ethnicity where the multiracial students are grouped into one category. There are nine options:
...
## Minority
Minority students are those students who are American Indian/Alaskan, Asian, Black/African American, Hawaiian/Pacific Islander, Hispanic, or Multiracial.
It does not include those students who are white, non-resident alien, or unspecified. The options are:

- Minority
- Non-minority

## US Citizenship
US Citizenship is the student's relationship to the United States. The options are:
...
## Athlete
An athlete is a student who was EVER on the official team roster on or after the first scheduled contest or date of NCAA competition. If the sql output is TRUE then the student is an athlete.
...
Concentration id/desc is a specific area of emphasis or concentration in a major chosen by a student. Not all majors have a concentration option.

## Student Level
##todo is it student level id? has student level id and student level desc; use utmetrics as a reference - utmetrics calls it student level
...
## Credit Load
Credit Load is the status of a student's time commitment based on how many credit hours attempted and the student's level for a given semester. The options are: 
...
## Global Residency
Global Residency is a mixture of international and tuition residency. If the student is an international student then their global residency is international. If the student is not international, then they are either in-state or out-of-state based on their tuition residency. They are in-state if their tuition residency is UT Resident, Changed from Non-Resident, American Indian Tribal Resident, Military, Out-of-State, or Housebill 102 - 2023. They are out-of-state if their tuition residency is Non-Resident of UT, Good Neighbor Tuition, Housebill 118/144 Waivers, Surcharge for excessive credits, or Undeclared. The options are:
...
## Athlete Term
An Athlete Term is a student who was on the official team roster on or after the first scheduled contest or date of NCAA competition that semester. If the sql output is TRUE then the student is an athlete.

## Distance Ed All
Distance Ed All students are students who are taking all of their courses through distance education. Distance education (DE) is education that uses one or more types of technology to deliver instruction to students who are separated from the instructor and to support regular and substantive interaction between the students and the instructor synchronously or asynchronously. This would include Broadcast, Interactive Audio/Video, Online/Internet, Remote Virtual and Remote Hybrid. If the sql output is TRUE then the student is Distance Ed All.

## Distance Ed Some
Distance Ed Some students are students who are taking at least one but not all of their courses through distance education. Distance education (DE) is education that uses one or more types of technology to deliver instruction to students who are separated from the instructor and to support regular and substantive interaction between the students and the instructor synchronously or asynchronously. This would include Broadcast, Interactive Audio/Video, Online/Internet, Remote Virtual and Remote Hybrid. If the sql output is TRUE then the student is Distance Ed Some.

## Distance Ed None
Distance Ed None students are students who are not taking any courses through distance education. Distance education (DE) is education that uses one or more types of technology to deliver instruction to students who are separated from the instructor and to support regular and substantive interaction between the students and the instructor synchronously or asynchronously. This would include Broadcast, Interactive Audio/Video, Online/Internet, Remote Virtual and Remote Hybrid. If the sql output is TRUE then the student is Distance Ed None.
