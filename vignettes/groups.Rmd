...
Groups define the ways you can categorize students. These groups can be placed in several classifications.

# Demopgraphic Groups
Data in this grouping is collected from the student at the time of their application for admission. This data is stored at the student level, in the student table.
...
# Term Based Groups
Data in this grouping can change each semester and is based on information from the system for this current term such as program, credit hours attempted, etc. This data is stored at the student term level, in the student_term_level table.
