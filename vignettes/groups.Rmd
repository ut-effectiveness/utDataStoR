...
# Term Based Groups
Data in this grouping can change each semester and is based on information from the system such as program, credit hours attempted, etc. This data is stored at the student term level, in the student_term_level table.
