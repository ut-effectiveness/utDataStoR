...
## Program Code/Desc
Program description is the students declared program of study (code or id/desc) at point of application. Programs are assigned to a department and departments are assigned to colleges. A program code is made up of a degree id, and major id and if applicable a concentration id.

## Concentration Desc
Concentration description is a specific area of emphasis or specialization (id/code) in a major chosen by a student. Not all majors have a concentration option.

## Degree Desc
Degree description is the description of the degree id/code that is tied to a students program.

## Major Desc
Major description is the description of the major id/code that is tied to a students program.
...
## Non-Matriculated
A non-degree-seeking student who is enrolled to per sue personal interests, not a credential. A Non-matriculated is a subset of Non-degree-seeking. If the sql output is TRUE then the student is a non-matriculated student.
