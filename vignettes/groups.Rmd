...
# Location Groups
Data in this classification is collected from the students FIRST application for admission. This data is stored at the student term level, in the student_term_level table.
