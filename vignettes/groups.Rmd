...
## Gender
Gender is the biological sex on a persons birth certificate. The options are M (Male) or F (Female).
--Add an unknown, check with Tasha and the action team


## IPEDS Race/Ethnicity
Data regarding the student's race and ethnicity. There are nine options:
- Hispanic
...
## Citizenship
Citizenship is the student's relationship to the United States. The options are: US Citizen; Non-Res Alien-Visa or temp bas; Res Alien-immigrant status; Non-Citizen National of US; Nonimmigrant Alien 53B-8-106; Deferred Action; Student curr defined as Other.
-- bullet the list
...
## Age Band
Age is how old a student is today based on their birth date. Reported as: <18; 18-24; 25-34; 35-44; 44-59; >= 60.
--bullet list

## First Generation Student
A first generation student is student where neither parent nor guardian has received their bachelor's degree. On the application the student is asked if either of their parent(s) or guardian(s) has received their bachelor degree, if they respond no then the student is a first generation student. If they respond yes or if they don't answer then the student is not a first generation student.

## Veteran
A veteran is a student who has served in the armed forces. This data includes anyone who is receiving veteran benefits (including family members).
...
## Class Level
A student's class level is based on their overall cumulative earned credit hours. For undergraduate students, he options are: Freshman <30 credit hours; Sophomore 30-59 credit hours; Junior 60-89 credit hours; Senior 90 or more credit hours. All graduate students are reported as Graduate.
A student's class level is not the same as their year in school, it is based on credit. There can be sophomores in their first semester, as well as freshmen in their third year.
--bullets

## Full-time Part-time
The status of a students time commitment based off of how many credit hours attempted and the student's level for a given semester. The options are: Full-time for Undergraduate students 12 or more credit hours, for Graduate students 9 or more credit hours; Part-time for Undergraduate students less than 12 credit hours, for Graduate students less than 9 credit hours.

## Residency
Residency is the state the student is a resident of as listed in the system of record. The options are: Resident; Non-Resident; Good Neighbor.
--bullet

## High School Student
A student is who is taking a course at Utah Tech University while still attending high school.

## GPA Band
A student's GPA is their Overall Cumulative GPA. This is reported in a GPA band: new (null - no GPA yet); 0-1.999; 2-2.499; 2.5-2.999; 3-4.0.
--bullet
