...
``` sql
`r display_sql_with_comments('groups', 'groups_demographics.sql')`
```
# Term Based Groups
...
``` sql
`r display_sql_with_comments('groups', 'groups_term_based.sql')`
```
...
``` sql
`r display_sql_with_comments('groups', 'groups_hs_concurrent.sql')`
```
...
``` sql
`r display_sql_with_comments('groups', 'groups_distance_ed.sql')`
```
