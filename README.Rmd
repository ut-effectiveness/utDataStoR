...
You can use this package to load our standard retention query, when you are in a project. If you run the code below, `{utDataStorR}` will add a new script titled `my_retention_query.sql` to the `sql` file in your project. 
